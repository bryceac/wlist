...
impl Import {
    pub fn run(&self) {
        ...
        let items = match origin_path {
            ...
            _ => if let Ok(decoded_items) = Item::from_tsv_file(&origin_path) {
                decoded_items
            } else {
                vec![]
            }
